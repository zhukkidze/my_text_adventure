...
int main() {
    ...
    if (careerChoice == 1) { // Programmer and info
        ...
        switch (bakerChoice) {
            case 'A': std::cout << "Learning from an relative as Granma gives you valuable hands-on experience and setting up your mind for baking art in the future\n";
            break;
            case 'B': std::cout << "Culinary school provides structured learning and certification.\n";
            ...
            break;
            case 'C': std::cout << "Starting your own bakery is challenging but rewarding.\n";
            break;
            default: std::cout << "Invalid choice. Please restart the program and try again.\n";
        ...
        switch (sportsChoice) {
            case 'A': std::cout << "A sports in school involves you from early age in sport activities. Also, school coaching and exposure to competitions will help to become a successful athlete.\n";
            break;
            case 'B': std::cout << "Competing locally helps build confidence and experience.\n";
            break;
            case 'C': std::cout << "A personal coach helps refine techniques and accelerate growth.\n";
            break;
            default: std::cout << "Invalid choice. Please restart the program and try again.\n"; 
